...
<body>
	<div style="position:inherit;padding:0 0.5rem;">
		...
		<h5>PS C:\Users\root> Silakan coba kembali ke <a href="/">[Beranda]</a>.</h5>
	  	...
	  	<br>
		<pre id="err"><?=json_encode(["Severity"=>$severity,"Message"=>$message,"Filename"=>$filepath,"LineNumber"=>$line],JSON_PRETTY_PRINT);?></pre>
	</div>
</body>
<footer>
	<script type="text/javascript">function xshow(){document.getElementById("err").style.display='block';};window.setTimeout(function(){window.location.href=`/`;},30000);</script>
</footer>
</html>